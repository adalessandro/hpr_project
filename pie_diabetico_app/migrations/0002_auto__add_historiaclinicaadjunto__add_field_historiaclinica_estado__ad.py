...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoriaClinicaAdjunto'
        db.create_table(u'pie_diabetico_app_historiaclinicaadjunto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('historia_clinica', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pie_diabetico_app.HistoriaClinica'])),
            ('adjunto', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
        ))
        db.send_create_signal(u'pie_diabetico_app', ['HistoriaClinicaAdjunto'])

        # Adding field 'HistoriaClinica.estado'
        db.add_column(u'pie_diabetico_app_historiaclinica', 'estado',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)

        # Adding field 'HistoriaClinica.antecedentes_otros'
        db.add_column(u'pie_diabetico_app_historiaclinica', 'antecedentes_otros',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'HistoriaClinica.ulceras_desc'
        db.add_column(u'pie_diabetico_app_historiaclinica', 'ulceras_desc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'HistoriaClinica.laboratorio'
        db.add_column(u'pie_diabetico_app_historiaclinica', 'laboratorio',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


        # Changing field 'HistoriaClinica.amputacion'
        db.alter_column(u'pie_diabetico_app_historiaclinica', 'amputacion', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):
        # Deleting model 'HistoriaClinicaAdjunto'
        db.delete_table(u'pie_diabetico_app_historiaclinicaadjunto')

        # Deleting field 'HistoriaClinica.estado'
        db.delete_column(u'pie_diabetico_app_historiaclinica', 'estado')

        # Deleting field 'HistoriaClinica.antecedentes_otros'
        db.delete_column(u'pie_diabetico_app_historiaclinica', 'antecedentes_otros')

        # Deleting field 'HistoriaClinica.ulceras_desc'
        db.delete_column(u'pie_diabetico_app_historiaclinica', 'ulceras_desc')

        # Deleting field 'HistoriaClinica.laboratorio'
        db.delete_column(u'pie_diabetico_app_historiaclinica', 'laboratorio')


        # Changing field 'HistoriaClinica.amputacion'
        db.alter_column(u'pie_diabetico_app_historiaclinica', 'amputacion', self.gf('django.db.models.fields.CharField')(max_length=2))
