...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoriaClinica.derm_observaciones'
        db.add_column(u'pie_diabetico_app_historiaclinica', 'derm_observaciones',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoriaClinica.derm_observaciones'
        db.delete_column(u'pie_diabetico_app_historiaclinica', 'derm_observaciones')
    ...
    models = {
        ...
        u'pie_diabetico_app.historiaclinica': {
            ...
            'derm_observaciones': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            ...
            'historia_clinica': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
