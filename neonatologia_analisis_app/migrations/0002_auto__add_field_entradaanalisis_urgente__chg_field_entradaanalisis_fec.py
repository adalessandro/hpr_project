...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntradaAnalisis.urgente'
        db.add_column(u'neonatologia_analisis_app_entradaanalisis', 'urgente',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'EntradaAnalisis.fecha_nacimiento'
        db.alter_column(u'neonatologia_analisis_app_entradaanalisis', 'fecha_nacimiento', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 3, 11, 0, 0)))

    def backwards(self, orm):
        # Deleting field 'EntradaAnalisis.urgente'
        db.delete_column(u'neonatologia_analisis_app_entradaanalisis', 'urgente')


        # Changing field 'EntradaAnalisis.fecha_nacimiento'
        db.alter_column(u'neonatologia_analisis_app_entradaanalisis', 'fecha_nacimiento', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'neonatologia_analisis_app.entradaanalisis': {
            ...
            'urgente': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
