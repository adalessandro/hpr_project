...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field determinaciones on 'EntradaAnalisis'
        m2m_table_name = db.shorten_name(u'neonatologia_analisis_app_entradaanalisis_determinaciones')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field determinaciones on 'EntradaAnalisis'
        db.delete_table(db.shorten_name(u'neonatologia_analisis_app_entradaanalisis_determinaciones'))
