...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntradaAnalisis.etapa'
        db.add_column(u'neonatologia_analisis_app_entradaanalisis', 'etapa',
                      self.gf('django.db.models.fields.CharField')(default='INI', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntradaAnalisis.etapa'
        db.delete_column(u'neonatologia_analisis_app_entradaanalisis', 'etapa')
