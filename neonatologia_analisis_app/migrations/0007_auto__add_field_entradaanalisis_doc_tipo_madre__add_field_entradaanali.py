...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntradaAnalisis.doc_tipo_madre'
        db.add_column(u'neonatologia_analisis_app_entradaanalisis', 'doc_tipo_madre',
                      self.gf('django.db.models.fields.CharField')(default='DNI', max_length=3),
                      keep_default=False)

        # Adding field 'EntradaAnalisis.doc_num_madre'
        db.add_column(u'neonatologia_analisis_app_entradaanalisis', 'doc_num_madre',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntradaAnalisis.doc_tipo_madre'
        db.delete_column(u'neonatologia_analisis_app_entradaanalisis', 'doc_tipo_madre')

        # Deleting field 'EntradaAnalisis.doc_num_madre'
        db.delete_column(u'neonatologia_analisis_app_entradaanalisis', 'doc_num_madre')
    ...
    models = {
        ...
        u'neonatologia_analisis_app.entradaanalisis': {
            ...
            'determinaciones': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['neonatologia_analisis_app.DeterminacionEstudioNeonatologia']", 'symmetrical': 'False'}),
