...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntradaAnalisis.prioridad'
        db.add_column(u'neonatologia_analisis_app_entradaanalisis', 'prioridad',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EntradaAnalisis.prioridad'
        db.delete_column(u'neonatologia_analisis_app_entradaanalisis', 'prioridad')
